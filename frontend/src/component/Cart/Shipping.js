...
const Shipping = () => {
  ...
  //   e.preventDefault();
  //   if (pinCode.length !== 6 || pinCode.trim === "")
  //     toast.error("Enter Pin Code properly");
  //   setLoading(true);
  //   axios
  ...
  //     } catch (error) {
  //       toast.error(
  //         "Not able to send otp. Please reload the page and try again."
  //       );
  //       // setLoading(false);
  //       console.log(error);
  //     }
          ...
          <div className="shippingContainer">
            <div className="shippingBox">
              ...
              <div className="shippingForm">
                ...
                {/* <button onClick={verifyPinCodeEntry} className="shippingBtn">
                  Verify Pin Code
                </button> */}
                ...
                {/* <div>
                  <KeyIcon
                    style={
                      verifyOtp ? { display: "none" } : { display: "block" }
                    }
                  />
                  <input
                    type="number"
                ...
                <button className="shippingBtn" onClick={shippingSubmit}>
                  Continue
                </button>
              </div>
